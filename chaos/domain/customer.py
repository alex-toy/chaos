"""
This is an example of what a Customer class could look like, for a subscription prediction use case.
This is just for the sake of example : this is not complete and you should adapt it to your own use case domain.
